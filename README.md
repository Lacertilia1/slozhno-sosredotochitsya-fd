...
Чтобы улучшить проект, я сосредоточен на:

- Исправить порядок подключения стилей при сборке с помощью Gulp  
- Автоматизировать создание новых форматов изображений  
- Автоматизировать оптимизацию изображений  
- Улучшить стили блоков согласно методологии BEM  
